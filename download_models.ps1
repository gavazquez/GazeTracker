...
$destination = "Libs/model/patch_experts/cen_patches_0.25_of.dat"

$d2 = (Join-Path (Get-Location) $destination)
...
# 0.35 scale models
$destination = "Libs/model/patch_experts/cen_patches_0.35_of.dat"
...
# 0.5 scale models
$destination = "Libs/model/patch_experts/cen_patches_0.50_of.dat"
...
# 1.0 scale models
$destination = "Libs/model/patch_experts/cen_patches_1.00_of.dat"
